...
export const Button = forwardRef(function Button(
  ...
  ref: React.ForwardedRef<HTMLAnchorElement | HTMLButtonElement> // Updated to match both cases
) {
  const classes = clsx(
    className,
    styles.base,
  ...
  if ("href" in props) {
    // If "href" exists, treat as a Link
    return (
      <Link
        {...(props as React.ComponentPropsWithoutRef<typeof Link>)} // Explicitly typecast props for Link
        className={classes}
        ref={ref as React.ForwardedRef<HTMLAnchorElement>} // Ensure correct type for Link
      >
  ...
  return (
    <Headless.Button
      {...(props as Omit<Headless.ButtonProps, "className">)} // Explicitly typecast props for Button
      className={clsx(classes, "cursor-default")}
      ref={ref as React.ForwardedRef<HTMLButtonElement>} // Ensure correct type for Button
    >
      <TouchTarget>{children}</TouchTarget>
    </Headless.Button>
  );
